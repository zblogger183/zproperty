  ...
  return (
    <div className="px-6 py-6">
      ...
      <p className="mt-1 text-sm text-primary-mid">
        Manage 301/302 URL redirects stored in the <code>redirects</code> table. Note: request-time enforcement
        (reading this table from <code>proxy.ts</code>) is not wired up yet — this page currently manages the
        data only.
      </p>
